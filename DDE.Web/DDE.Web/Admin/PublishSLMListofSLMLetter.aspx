<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublishSLMListofSLMLetter.aspx.cs" Inherits="DDE.Web.Admin.PublishSLMListofSLMLetter" %>
...
<body>
    ...
    <asp:Label ID="lblLNo" runat="server" Text=""></asp:Label>
    </div>
