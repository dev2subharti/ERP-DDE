...
{
    public partial class CPFirstTime : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                if (Session["NoTimesLoggedIn"].ToString() == "0")
                {
                ...
                {
                    Log.IncreaseLoggedIntimes(Session["NoTimesLoggedIn"].ToString(),Convert.ToInt32(Session["ERID"]));
        ...
        {
            if (tbPriviousPassword.Text == getPrePassword())
            {
                    ...
                    Log.IncreaseLoggedIntimes("0", Convert.ToInt32(Session["ERID"]));
