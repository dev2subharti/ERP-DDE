<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="ShowDAApproved.aspx.cs" Inherits="DDE.Web.Admin.ShowDAApproved" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div class="heading">
            Show Degree Applications Approved for Printing
        </div>
        ...
        <div style="padding-top: 10px">
            <asp:Button ID="btnPrint" runat="server" Text="Print Address" OnClick="btnPrint_Click" Visible="false" />
        </div>
                        ...
                        <table align="left">
                            <tr>
                                ...
                                <td align="center" style="width: 80px">
                                    <asp:Button ID="btnShow" runat="server" Width="80px" CssClass="btn" Text="Show" CommandName="Show" CommandArgument='<%#Eval("DIID")%>' />
                                </td>
