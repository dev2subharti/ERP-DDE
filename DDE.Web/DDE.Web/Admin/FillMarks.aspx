<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="FillMarks.aspx.cs" Inherits="DDE.Web.Admin.FillMarks" %>
...
<asp:Content ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList ID="ddlistExam" runat="server" Width="150px" 
                                        AutoPostBack="true" onselectedindexchanged="ddlistExam_SelectedIndexChanged">
            ...
            <div align="center">
                <asp:DataList ID="dtlistShowStudents" runat="server" CssClass="dtlist" runat="server" HeaderStyle-CssClass="dtlistheader"
