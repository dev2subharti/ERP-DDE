<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="ShowReappearExamReport.aspx.cs" Inherits="DDE.Web.Admin.ShowReappearExamReport" %>

<asp:Content ContentPlaceHolderID="cphBody" runat="server">
<asp:Panel ID="pnlData" runat="server" Visible="false">
    <div class="heading">
        Show Reappear Examination Report
    </div>
