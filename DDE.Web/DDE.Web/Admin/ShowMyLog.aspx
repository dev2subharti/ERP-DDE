<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="ShowMyLog.aspx.cs" Inherits="DDE.Web.Admin.ShowMyLog" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div>
            ...
            <div align="center">
                <asp:GridView ID="gvLog" Width="1000px" runat="server" HeaderStyle-CssClass="gvheader" RowStyle-CssClass="gvitem" >
                </asp:GridView>
            </div>
        </div>
    </asp:Panel>
