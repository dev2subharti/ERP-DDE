<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/StudyCentre.Master"
    CodeBehind="FillPracticalMarksBySC.aspx.cs" Inherits="DDE.Web.Admin.FillPracticalMarksBySC" %>
            ...
            <div align="center" class="text" style="padding-top: 20px; padding-bottom: 20px">
                <table cellspacing="10px" class="tableStyle2">
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlistMOE" runat="server" Width="150px" Enabled="false">
                                <asp:ListItem>--SELECT ONE--</asp:ListItem>
                    ...
                    <tr>
                        <td align="left">
                            <b>
                                <asp:Label ID="lblPractical" runat="server" Text="Practical" Visible="false"></asp:Label></b>
                        </td>
                        <td align="left">
                            <asp:DropDownList ID="ddlistPractical" runat="server" Width="150px" Visible="false"
                                AutoPostBack="true" OnSelectedIndexChanged="ddlistPractical_SelectedIndexChanged">
                                <asp:ListItem>--SELECT ONE--</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td align="left">
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlistSession" runat="server" Visible="false" Width="150px"
