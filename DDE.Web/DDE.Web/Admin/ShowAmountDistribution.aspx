<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="ShowAmountDistribution.aspx.cs" Inherits="DDE.Web.Admin.ShowAmountDistribution" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div align="center">
        <asp:Panel ID="pnlData" runat="server" Visible="false">
            <div class="heading">
               Show Amount Distribution of Instrument
            </div>
                        ...
                        <ItemTemplate>
                            <table align="left">
                                <tr>
                                    ...
                                    <td align="left" style="width: 125px">
                                        <asp:TextBox ID="tbAmount" runat="server" Text='<%#Eval("Amount")%>' Enabled="false" BackColor="White" ForeColor="Black" Width="50px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
                    ...
                    <asp:Panel ID="pnlBalance" runat="server" Visible="false">
                        <table class="tableStyle2" cellspacing="10px">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbBalance" Enabled="false" BackColor="White" ForeColor="Black" runat="server"></asp:TextBox>
                                </td>
                            </tr>
