<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="GenerateQuestionPaper1.aspx.cs" Inherits="DDE.Web.Admin.GenerateQuestionPaper1" %>
            ...
            <div align="center" class="text" style="padding-top: 20px">
                <table class="tableStyle2" cellspacing="10px">
                   ...
                   <tr>
                        ...
                        <td align="left" colspan="5">
                            <asp:DropDownList ID="ddlistMOE" Enabled="false" runat="server">
                               
                                <asp:ListItem Value="R">MAIN EXAM</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" class="border_rb" style="width: 100px">
                                                        <asp:Label ID="lblPaperCode" runat="server" Text='<%#Eval("PaperCode")%>'></asp:Label>
                                                         <asp:Label ID="lblTQ" runat="server" Text='<%#Eval("TQ")%>' Visible="false"></asp:Label>
                                                        <asp:Label ID="lblSetQP" runat="server" Text='<%#Eval("SetQP")%>' Visible="false"></asp:Label>
                                                    ...
                                                    <td align="center" class="border_rb" style="width: 70px">
                                                      ...
                                                      <td align="center" class="border_rb" style="width: 100px">
                                                        <asp:LinkButton ID="lnkbtnSet" runat="server" Text="Set QP" OnClick="lnkbtnSet_Click" ToolTip='<%#Eval("PaperCode") %>' CommandName=' <%#Eval("Year")%>' CommandArgument='<%#Eval("SySession") %>'></asp:LinkButton>
                                                    </td>
                                                     <td align="center" class="border_rb" style="width: 100px">
