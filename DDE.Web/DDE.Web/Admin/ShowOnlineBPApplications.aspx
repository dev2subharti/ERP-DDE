<%@ Page Language="C#"  AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="ShowOnlineBPApplications.aspx.cs" Inherits="DDE.Web.Admin.ShowOnlineBPApplications" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div>
            <div align="center" class="heading">
                <b>Show Online Back Paper Applications</b>
            </div>
