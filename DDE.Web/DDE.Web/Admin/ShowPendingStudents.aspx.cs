...
{
    public partial class ShowPendingStudents : System.Web.UI.Page
    {
        ...
        private void populateStudents()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select SRID,ApplicationNo,StudentName,FatherName,Session,CYear,ReasonIfPending from DDEStudentRecord where AdmissionStatus='2' and RecordStatus='False' order by StudentName", con);
            con.Open();
            SqlDataReader dr;
