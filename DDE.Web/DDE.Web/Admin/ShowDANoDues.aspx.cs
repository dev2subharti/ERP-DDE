...
{
    public partial class ShowDANoDues : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Authorisation.authorised(Convert.ToInt32(Session["ERID"]), 116) || Authorisation.authorised(Convert.ToInt32(Session["ERID"]), 117))
            {
        ...
        {
            bool auth = false;
            if (Authorisation.authorised(Convert.ToInt32(Session["ERID"]), 117))
            {
                auth = true;
            }
        ...
        protected void dtlistShowDegreeInfo_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("DegreeND.aspx?SRID=" + Convert.ToInt32(srid.Text)+"&DIID="+e.CommandArgument);
            }
        }
