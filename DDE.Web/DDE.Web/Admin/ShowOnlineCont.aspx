<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master"
    CodeBehind="ShowOnlineCont.aspx.cs" Inherits="DDE.Web.Admin.ShowOnlineCont" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div>
            <div align="center" class="heading">
                <b>Show Online Continuation Applications</b>
            </div>
                            ...
                            <tr>
                                ...
                                <td align="center" style="width: 80px">
                                    <asp:LinkButton ID="lnkbtnFillFee" runat="server" Text="Register" OnClientClick="aspnetForm.target ='_blank';" CommandName="Register"
                                        CommandArgument='<%#Eval("OURID") %>'></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
