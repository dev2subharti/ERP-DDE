<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="GenerateQRCodeForTS.aspx.cs" Inherits="DDE.Web.Admin.GenerateQRCodeForTS" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div align="center">
        <asp:Panel ID="pnlData" runat="server" Visible="false">
            <div class="heading">
                Generate / Search QR Code Trans Script
            </div>
