                        ...
                        Log.createLogNow("Fee Submit", "Filled"+ddlistFeeHead.SelectedItem.Text+" Fee of a student with Enrollment No '" + tbEnNo.Text + "'", Convert.ToInt32(Session["ERID"].ToString()));
                         ...
                         else if (ddlistFeeHead.SelectedItem.Value == "2" || ddlistFeeHead.SelectedItem.Value == "26")
                         {
                             ...
                             else
                             {
                                 ...
                                 if (examrecorderror=="")
                                 {
                                     ...
                                     else if (ddlistExamination.SelectedItem.Value == "A14" || ddlistExamination.SelectedItem.Value == "B14" || ddlistExamination.SelectedItem.Value == "A15" || ddlistExamination.SelectedItem.Value == "B15" || ddlistExamination.SelectedItem.Value == "A16" || ddlistExamination.SelectedItem.Value == "B16" || ddlistExamination.SelectedItem.Value == "A17" || ddlistExamination.SelectedItem.Value == "B17" || ddlistExamination.SelectedItem.Value == "A18" || ddlistExamination.SelectedItem.Value == "B18" || ddlistExamination.SelectedItem.Value == "A19" || ddlistExamination.SelectedItem.Value == "W10" || ddlistExamination.SelectedItem.Value == "Z10" || ddlistExamination.SelectedItem.Value == "W11")
                                     {
                         ...
                         else if (ddlistFeeHead.SelectedItem.Value == "3")
                         {
                             ...
                             if (Exam.examRecordExist(Convert.ToInt32(lblSRID.Text), Convert.ToInt32(ddlistYear.SelectedItem.Value), ddlistExamination.SelectedItem.Value, "B"))
                             {
                                 ...
                                 if (rollno != "")
                                 {
                                     if (ddlistExamination.SelectedItem.Value == "A14" || ddlistExamination.SelectedItem.Value == "B14" || ddlistExamination.SelectedItem.Value == "A15" || ddlistExamination.SelectedItem.Value == "B15" || ddlistExamination.SelectedItem.Value == "A16" || ddlistExamination.SelectedItem.Value == "B16" || ddlistExamination.SelectedItem.Value == "A17" || ddlistExamination.SelectedItem.Value == "B17" || ddlistExamination.SelectedItem.Value == "A18" || ddlistExamination.SelectedItem.Value == "B18" || ddlistExamination.SelectedItem.Value == "A19" || ddlistExamination.SelectedItem.Value == "W10" || ddlistExamination.SelectedItem.Value == "Z10" || ddlistExamination.SelectedItem.Value == "W11")
                                     {
