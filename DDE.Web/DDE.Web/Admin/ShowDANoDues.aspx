<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="ShowDANoDues.aspx.cs" Inherits="DDE.Web.Admin.ShowDANoDues" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div class="heading">
            Show Degree Applications for No Dues
        </div>
                        ...
                        <table align="left">
                            <tr>
                                ...
                                <td align="center" style="width: 80px">
                                    <asp:Button ID="btnShow" CssClass="btn" Width="80px" runat="server" Text="Show" CommandName="Show" CommandArgument='<%#Eval("DIID")%>' />
                                </td>
