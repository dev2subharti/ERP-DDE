<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="ShowMarkSheet4.aspx.cs" Inherits="DDE.Web.Admin.ShowMarkSheet4" %>
      ...
      <div style="padding-top: 10px">
        ...
        <div align="center" style="font-family: Arial; padding-top: 0px;">
           <div>
            ...
            background-position: center; font-family: Arial; font-size: 19px; padding-top: 0px;
            height: 1100px">
            <table width="100%">
                <tr>
                    <td align="center">
                                            ...
                                            <asp:Table ID="tblResult" Width="220px" runat="server" CellSpacing="0">
                                                <asp:TableRow ID="tr1" runat="server">
                                                    ...
                                                    <asp:TableCell ID="td2" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
                                                        HorizontalAlign="Center"> <asp:Label ID="lblResult" runat="server" Font-Bold="True"></asp:Label></asp:TableCell>
                                                </asp:TableRow>
                                                <asp:TableRow ID="tr2" runat="server">
                                                    ...
                                                    <asp:TableCell ID="td4" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
                                                        HorizontalAlign="Center"> <asp:Label ID="lblDivision" runat="server" Font-Bold="True"></asp:Label></asp:TableCell>
                                                </asp:TableRow>
                                            </asp:Table>
                                        </div>
