<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="ShowConfirmedApplications.aspx.cs" Inherits="DDE.Web.Admin.ShowConfirmedApplications" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div>
            <div align="center" class="heading">
                <b>Show Confirmed Online Applications</b>
            </div>
                        ...
                        <table align="left">
                            <tr>
                                ...
                                <td align="center" style="width: 120px">
                                    <asp:LinkButton ID="lnkbtnRecycle" runat="server" OnClientClick="aspnetForm.target ='_blank';" Text="Show Details" CommandName="Confirm"
