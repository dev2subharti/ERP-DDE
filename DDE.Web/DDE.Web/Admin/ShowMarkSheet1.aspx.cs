...
{
    public partial class ShowMarkSheet1 : System.Web.UI.Page
    {
        int fototal = 0;
        int fmtotal = 0;
        ...
        private int populateStudentDetail()
        {
            ...
            while (dr.Read())
            {
                ...
                if (Session["ExamCode"].ToString() == "A13" || Session["ExamCode"].ToString() == "B13" || Session["ExamCode"].ToString() == "A14")
                {
        ...
        private void populateSubjectMarks()
        {
            ...
            else if (Session["ExamCode"].ToString() == "A14")
            {
                string ss = "";
                if ((Session["SySession"].ToString() == "A 2013-14") && (Session["ExamCode"].ToString() == "A14") && (lblENo.Text.Substring(0, 3) == "A13") && (Session["Year"].ToString() == "2") && (FindInfo.findCourseIDBySRID(Convert.ToInt32(lblSRID.Text)) == 76))
                {
                    ss = "A 2010-11";
                }
                else
        ...
        private void populateSMarks(int srid, string moe)
        {
            ...
            foreach (DataListItem li in dtlistSubMarks.Items)
            {
                ...
                if ((Session["ExamCode"].ToString() == "A14" && moe == "B"))
                {
