<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowMarksheet5.aspx.cs" Inherits="DDE.Web.Admin.ShowMarksheet5" %>
...
<body style="margin: 0px; background-image: url(images/msback2.jpg); width: 100%; background-repeat: repeat">
    <form id="form1" runat="server">
        <asp:Panel ID="pnlData" runat="server" Visible="true">
            ...
            <div align="center" style="font-family: Arial; padding-top: 0px;">
                ...
                <div style="background-image: url(images/ddelogo5.png); background-repeat: no-repeat; background-position: center; font-family: Arial; font-size: 19px; padding-top: 0px;">
                    <table width="100%">
                        <tr>
                            <td align="center">
