<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master" CodeBehind="ShowDAStatus.aspx.cs" Inherits="DDE.Web.Admin.ShowDAStatus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div class="heading">
            Show Status of Degree Applications
        </div>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlistType" Width="180px" AutoPostBack="true" 
                            runat="server" onselectedindexchanged="ddlistType_SelectedIndexChanged">
                             ...
                             <asp:ListItem Value="2">PR PENDIND</asp:ListItem>
                            <asp:ListItem Value="3">PR CONFIRMED</asp:ListItem>
                            <asp:ListItem Value="4">NO DUES PENDING</asp:ListItem>
                            <asp:ListItem Value="5">NO DUES CONFIRMED</asp:ListItem>
                            <asp:ListItem Value="6">PRINT PENDING</asp:ListItem>
                            <asp:ListItem Value="7">PRINTED</asp:ListItem>
