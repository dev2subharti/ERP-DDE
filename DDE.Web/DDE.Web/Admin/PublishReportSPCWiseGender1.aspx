<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master"
    CodeBehind="PublishReportSPCWiseGender1.aspx.cs" Inherits="DDE.Web.Admin.PublishReportSPCWiseGender1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        ...
        <div>
            ...
            <div align="center">
                <asp:GridView ID="gvReport" HeaderStyle-CssClass="gvheader" RowStyle-CssClass="gvitem"
                    runat="server">
                </asp:GridView>
            </div>
        </div>
