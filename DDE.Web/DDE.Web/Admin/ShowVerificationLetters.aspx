<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/MasterPages/Admin.Master"
    CodeBehind="ShowVerificationLetters.aspx.cs" Inherits="DDE.Web.Admin.ShowVerificationLetters" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <asp:Panel ID="pnlData" runat="server" Visible="false">
        <div style="padding-bottom: 20px">
            <div align="center" class="heading" style="padding-bottom: 20px">
                Show Verification Letters
            </div>
                            ...
                            <tr>
                                ...
                                <td align="left" style="width: 120px">
                                 ...
                                 <td align="left" style="width: 60px">
                                     <asp:LinkButton ID="lnkbtnShow" runat="server" CommandArgument='<%#Eval("LNo")%>' CommandName="Show">Show</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
